...
namespace day_2020_12_09.tests
{
    public class SolverTests
    {
        ...
        [TestCase(new long[] {35,20,15,25,47,40,62,55,65,95,102,117,150,182,127,219,299,277,309,576}, 127, 62)]
        public void Part2(long[] numbers, long targetSum, int result)
        {
            Assert.That(Solver.Part2(numbers, targetSum), Is.EqualTo(result));
        }
